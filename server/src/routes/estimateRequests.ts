...
router.post('/', requireExplicitCompanyScope, createEstimateRequest);
...
router.post('/:id/decision', requireExplicitCompanyScope, requireEstimateRequestManage, recordCommercialDecision);

...
const mockOcr = () => ({ contact: { name: '김컨코', company: 'CON-COST', department: '영업본부', position: '팀장', mobile: '010-1234-5678', telephone: '02-1234-5678', fax: '', email: 'demo-f6b4b83fad8b@example.invalid', homepage: 'https://concost.example', address: '서울특별시' }, confidence: 0.97, language: 'ko' });

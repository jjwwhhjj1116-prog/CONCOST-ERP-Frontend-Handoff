...
| DRIFT-10 | Finance | Access guards, ledger, balance, cashflow, approval draft candidates | Finance capability, ledger, evidence, export APIs | BACKEND_REQUIRED | Production persistence blocked |

...
export type AccessGrade = 'ADMIN' | 'GRADE_1' | 'GRADE_2' | 'GRADE_3' | 'GRADE_4';
export type AccessCapability = 'FINANCE_ACCESS';
...
export interface PersonnelCard {
  ...
  organizationMemberships?: OrganizationMembershipRef[];

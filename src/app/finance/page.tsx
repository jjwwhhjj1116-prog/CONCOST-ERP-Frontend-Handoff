...
export default function FinancePage() {
  return (
    <div className="space-y-6">
      <ErpDashboard eyebrow="Finance ERP workspace" title="재무" description="매출·매입과 증빙, 수금·지급, 예산·자금을 권한 범위에서 통합 관리합니다." theme="finance" stats={[{ label: '이번 달 매출', value: '₩0', detail: '원장 연결 대기' }, { label: '수금 예정', value: '₩0', detail: '미수금 기준' }, { label: '지급 예정', value: '₩0', detail: '미지급 기준' }, { label: '가용 자금', value: '₩0', detail: '계좌 연계 대기' }]} modules={modules} />
      <BusinessModuleWorkbench module="FINANCE" />
    </div>
  );
}

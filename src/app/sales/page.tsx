...
import { BusinessModuleWorkbench } from '@/components/handoff/BusinessModuleWorkbench';
...
export default function SalesPage() {
  ...
  return (
    <div className="space-y-6">
      <ErpDashboard eyebrow="Sales ERP workspace" title="영업" description="고객 발굴부터 견적·계약·수주까지 영업 흐름과 담당자 주소록을 연결합니다." theme="sales" stats={[{ label: '등록 고객·담당자', value: String(contactCount), detail: '명함 OCR 포함' }, { label: '진행 기회', value: '0', detail: '파이프라인 연결 대기' }, { label: '이번 달 견적', value: '0', detail: 'OFFDAY2 연계' }, { label: '수주 전환', value: '0%', detail: '운영 데이터 기준' }]} modules={modules} />
      <BusinessModuleWorkbench module="SALES" />
    </div>
  );
}
